...
<div class="Numbering">订单编号:<b>NJHDXJ201509-001</b></div></div>
 ...
 <!--收件人信息-->
    ...
    <div class="Info_style clearfix">
      ...
      <a href="#" class="img_link"><img src="product_img/p_3.jpg" /></a>
      <span>
      ...
      <div class="product_info clearfix">
      <a href="#" class="img_link"><img src="product_img/p_5.jpg" /></a>
      <span>
      <a href="#" class="name_link">美果汇 美国进口嘎啦果苹果6粒装 加力果 姬娜果 伽利果 新鲜应季水果</a>
      <b>也称为姬娜果，饱满色艳，个头小</b>
      <p>规格：39.9/5kg</p>
      ...
      <p>状态：<i class="label label-success radius">有货</i></p>   
       ...
       <div class="product_info clearfix">
      <a href="#" class="img_link"><img src="product_img/p_8.jpg"/></a>
      <span>
      <a href="#" class="name_link">美果汇 美国进口嘎啦果苹果6粒装 加力果 姬娜果 伽利果 新鲜应季水果</a>
      <b>也称为姬娜果，饱满色艳，个头小</b>
      <p>规格：500g/斤</p>
     ...
     <div class="Info_style clearfix">
      <div class="col-xs-3">  
        ...
        <div class="col-xs-3">  
         ...
         <div class="o_content">45464654654</div>
        </div>
        </div>
...
<div class="Button_operation">
				<button onclick="article_save_submit();" class="btn button_btn bg-deep-blue margin-top" type="submit"><i class="icon-save "></i>返回上一步</button>
