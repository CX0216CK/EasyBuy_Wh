    ...
    <div class="defray_list cover_style clearfix" id="Insidepage" >
     <div class="type_title same_module">在线支付方式</div>
      <div class="defray_content clearfix padding15">
        ...
        <b>提示：</b>该支付方式启用并不能正常使用，需要开通支付功能才能使用相应的支付方式。<a href="javascript:void()" class="fa fa-close close_Promp"></a></div>
      <div class="clearfix" id="species">
       ...
       <li class="defray_name">支付宝</li>
        ...
        <a href="javascript:ovid()" class="btn button_btns btn-danger"><i class="fa fa-trash"></i>&nbsp;删除</a>
         <a href="javascript:ovid()" class="btn button_btns btn-Dark-success"><i class="fa  fa-edit "></i>&nbsp;设置</a>
        </li>
       </ul>
       <ul class="defray_info">
       <li class="defray_name">微信支付</li>
        ...
        <li class="operating ptb10">
        <a href="javascript:ovid()" class="btn button_btns btn-Dark-success"><i class="fa fa-trash"></i>&nbsp;删除</a>
       ...
       <li class="defray_name">银联</li>
        ...
        <li class="operating ptb10">
        <a href="javascript:ovid()" class="btn button_btns btn-danger"><i class="fa fa-trash"></i>&nbsp;删除</a>
        <a href="javascript:ovid()" name="Payment_details.html" title="银联支付详细" onclick="Paymentdetails('134')" class="btn button_btns btn-Dark-success"><i class="fa  fa-newspaper-o "></i>&nbsp;详细</a>
        </li>
       </ul>
        <ul class="defray_info">
