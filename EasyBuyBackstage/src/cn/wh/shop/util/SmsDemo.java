...
public class SmsDemo {
	...
	static final String accessKeyId = "LTAIstiGE85Aqlqa";
	static final String accessKeySecret = "WVz8fZWhGelldvtVESFvHO5mcPEi6z";
	static int a;
	...
	public static SendSmsResponse sendSms(String phone) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("云课堂");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_132735032");
		// 可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
		a = (int) ((Math.random() * 9 + 1) * 10000);
	...
	public static QuerySendDetailsResponse querySendDetails(String bizId)
		...
		// 必填-号码
		request.setPhoneNumber("13520995903");
		// 可选-流水号
	...
	public static void main(String[] args) throws ClientException,
		...
		// 发短信
		SendSmsResponse response = sendSms("13207530830");
